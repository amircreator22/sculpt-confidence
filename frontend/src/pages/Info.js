...
const CONTENT = {
  'shipping-returns': {
    ...
    sections: [
      ...
      { h: '30-Day Returns', body: 'Changed your mind? You have 30 days from delivery to return unworn items with tags attached for a full refund to your original payment method. Start a return by emailing hello@sculptiva.co.uk with your order number.' },
  ...
  'privacy-policy': {
    ...
    sections: [
      ...
      { h: 'Your Rights (UK GDPR)', body: 'You can request access to, correction of, or deletion of your personal data at any time by emailing hello@sculptiva.co.uk. We respond within 30 days. You may also complain to the ICO if you believe your data has been mishandled.' },
  ...
  'terms-conditions': {
    ...
    sections: [
      ...
      { h: 'Contact', body: 'Sculptiva, Blackburn, United Kingdom. hello@sculptiva.co.uk.' },
    ],
  },
};
