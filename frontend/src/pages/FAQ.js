...
const FAQS = [
  ...
  { q: 'How do I get featured on your socials?', a: (<>Tag <a href="https://www.instagram.com/sculptivaofficial" target="_blank" rel="noreferrer" className="underline hover:text-[#c98d92] transition-colors" data-testid="faq-instagram-link">@sculptivaofficial</a> and #Sculptiva in your training clips and photos. We feature real community members every week — every body, every level, every journey.</>) },
