...
export const BLOG_POSTS = {
  ...
  'scrunch-bum-leggings-ultimate-buying-guide': {
    titleTag: "Scrunch Bum Leggings: The Ultimate 2026 Buying Guide | Sculptiva",
    metaDesc:
      "Everything to check before buying scrunch bum leggings in 2026 \u2014 seam placement, fabric, sizing, and how to spot a pair built to actually hold its shape.",
    ...
    faqs: [
      { q: "What's the single biggest difference between a good and a bad scrunch bum legging?", a: "Base fabric quality. The scrunch seam itself is a fairly simple construction choice \u2014 what makes or breaks a pair is whether it's built on dense, squat-proof, four-way-stretch fabric or a thin fabric that shifts and loses shape under movement." },
      { q: "Should I size down to get a tighter scrunch effect?", a: "No \u2014 sizing down pulls the fabric flat across the seam and flattens the gather rather than enhancing it. Size to your usual measurements on compression-grade fabric for the best shaping." },
      { q: "Do scrunch bum leggings work on every body shape?", a: "The seam is designed to follow natural curve, so it can work across body shapes, but only if it's been fit-tested on a size range rather than designed around one sample size." },
      { q: "How do I know if a listing is just describing a normal legging with marketing language?", a: "Check for specifics: mentions of seam placement testing, the actual base fabric composition and compression level, and construction detail beyond \"lifting effect\" claims. Vague marketing copy with no construction detail is a red flag." },
    ],
    primary: { label: "Shop Scrunch Bum Leggings", href: "/collections/scrunch-bum-leggings" },
    links: [
      { label: "What Is a Scrunch Seam?", href: "/blog/what-is-a-scrunch-seam" },
      { label: "Do Scrunch Bum Leggings Actually Work?", href: "/blog/do-scrunch-bum-leggings-actually-work" },
      { label: "Best Scrunch Bum Leggings for Leg Day", href: "/blog/best-scrunch-bum-leggings-for-leg-day" },
    ],
  },
...
export const COLLECTION_ARTICLE = {
  ...
  'scrunch-bum-leggings': [
    { slug: 'scrunch-bum-leggings-ultimate-buying-guide', label: 'Scrunch bum leggings: the ultimate 2026 buying guide' },
